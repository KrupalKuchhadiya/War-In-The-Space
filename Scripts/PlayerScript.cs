...
public class PlayerScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButton(0))
        {
            ...
            float clamped_Y = Mathf.Clamp(mousePosition.y, -height_Screen, height_Screen);
            ...
            Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.RightArrow))
        {
            ...
            float clampedX = Mathf.Clamp(transform.position.x, -width_Screen + width_PlayerSprite, width_Screen - width_PlayerSprite - 0.25f);
            float clampedY = Mathf.Clamp(transform.position.y, -height_Screen + height_PlayerSprite, height_Screen - height_PlayerSprite - 0.4f);
